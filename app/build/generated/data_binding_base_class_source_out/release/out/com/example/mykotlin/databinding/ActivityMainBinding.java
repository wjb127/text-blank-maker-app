...
package com.example.mykotlin.databinding;
...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull TextView counterText,
      @NonNull Button incrementButton, @NonNull Button resetButton) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, counterText, incrementButton,
          resetButton);
    }
